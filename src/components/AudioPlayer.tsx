...
export function AudioPlayer({ item, onEnded, onNext, onPrev, accentColor = 'emerald', icon }: AudioPlayerProps) {
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // ALL hooks at the top — unconditional (React rules)
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  const [embedLoading, setEmbedLoading] = useState(true); // For cloud embed player
  ...
  // Reset embed loading on track change
  ...
  // CRITICAL: Always sync volume to audio element
  useEffect(() => {
    const audio = audioRef.current;
    if (!audio) return;
  ...
  const bars = useMemo(() =>
    Array.from({ length: 40 }, (_, i) => 20 + Math.sin(i * 0.7) * 25 + Math.cos(i * 1.3) * 20),
  []);

  // Default music icon SVG
  ...
  // Shared album art component
  const albumArt = (spinning: boolean) => (
    <div className={cn(
      ...
      <SmartImage
        src={thumbnail}
        alt={item.title}
        fallbackGradient={`${gradientFrom} ${gradientTo}`}
        fallbackContent={<div className="opacity-100">{defaultIcon}</div>}
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // CLOUD EMBED PLAYER — For Mega, GDrive, OneDrive, etc.
  ...
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  // DIRECT AUDIO PLAYER (MP3, Dropbox raw, direct)
  // Full custom controls — volume, seek, speed, repeat
  // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  return (
    <div className={cn('overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-gray-900', bgTone, 'shadow-2xl shadow-black/40 border border-white/[0.06]')}>
      {/* Audio element — NO crossOrigin to prevent CORS errors */}
      ...
      <div className="relative p-4 sm:p-5">
        ...
        {/* Track info with spinning album art */}
