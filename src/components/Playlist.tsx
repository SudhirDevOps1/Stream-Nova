...
// Small thumbnail using SmartImage with YouTube fallback
  ...
  return (
    <div className={cn(
      ...
      <SmartImage
        src={thumbUrl}
        alt={item.title}
        fallbackGradient={gradients[accentColor]}
        fallbackContent={<Icon className="h-4 w-4 text-white opacity-50" />}
        className="absolute inset-0"
      />
      {/* Play overlay on hover */}
      {!isActive && (
        <div className="absolute inset-0 flex items-center justify-center bg-black/30 opacity-0 group-hover/item:opacity-100 transition-opacity z-10">
